    ...
    plugins.lazy = {
      ...
      plugins = [
        ...
        { pkg = pkgs.vimPlugins.plenary-nvim; }
        {
          ...
          opts = {
            ensure_installed =
              [ "javascript" "typescript" "c" "lua" "cpp" "nix" ];
            sync_install = false;
            auto_install = true;
            indent.enable = true;
            highlight = {
        ...
        { pkg = pkgs.vimPlugins.refactoring-nvim; }
        ...
        { pkg = pkgs.vimPlugins.nvim-web-devicons; }
        {
          ...
          opts = {
            force_inactive = {
              filetypes =
                [ "^dapui_*" "^help$" "^neotest*" "^NvimTree$" "^qf$" ];
            };
        ...
        {
          pkg = pkgs.vimPlugins.lsp-progress-nvim;
          opts = {
            spinner = [ "⠋" "⠙" "⠸" "⢰" "⣠" "⣄" "⡆" "⠇" ];
            client_format.__raw = ''
              function(_, spinner, series_messages)
